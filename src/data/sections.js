export const sections = [
  {
    ...
    subSections: [
      {
        title: 'Vertice International',
        subTitle: 'Bangkok, Thailand',
        info: 'January 2017 - Present',
      ...
      },
      {
        title: 'Vertice International',
        subTitle: 'Bangkok, Thailand',
        info: 'January 2016 - December 2016',
        bodyTitle: 'Lead Software Developer',
        bodyDetails: [
          'Coordinate with Japanese developers and Thai developers for smooth workflow',
          'Worked with VB.NET to build Windows application called Extreme (Car Trading & Management System)'
        ]
      },
      {
        title: 'Vertice International',
        subTitle: 'Bangkok, Thailand',
        info: 'December 2014 - December 2015',
        bodyTitle: 'Software Developer',
        bodyDetails: [
          'Worked with VB.NET to build Windows application called Extreme (Car Trading & Management System)'
        ]
      },
      {
        title: 'Evolix',
        subTitle: 'Bangkok, Thailand',
        info: 'February 2013 - April 2014',
        bodyTitle: 'Software Developer',
        bodyDetails: [
          'Built Android application that integrated with Microsoft CRM',
          'Worked with C# and ASP.NET to implement web service that connected to Microsoft CRM and Android App'
        ]
      }
    ]
  },
